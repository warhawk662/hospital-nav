...
// node_modules/ngraph.path/dist/ngraph.path.es.js
function y(e, t) {
...
function U(e) {
  this.node = e, this.parent = null, this.closed = false, this.open = 0, this.distanceToSource = Number.POSITIVE_INFINITY, this.fScore = Number.POSITIVE_INFINITY, this.heapIndex = -1;
}
function R() {
  var e = 0, t = [];
  return {
  ...
  function d(o) {
    var r = t[e];
    return r ? (r.node = o, r.parent = null, r.closed = false, r.open = 0, r.distanceToSource = Number.POSITIVE_INFINITY, r.fScore = Number.POSITIVE_INFINITY, r.heapIndex = -1) : (r = new U(o), t[e] = r), e++, r;
  }
}
function $(e, t) {
...
function j(e, t) {
  ...
  function T(p, x) {
    ...
    for (var h; H.length > 0; ) {
      ...
      h.closed = true, e.forEachLinkedNode(h.node.id, S, n);
    }
    return oe;
    function S(v, O) {
      var c = E.get(v.id);
...
function z(e, t) {
  ...
  function T(p, x) {
    ...
    for (var O = Number.POSITIVE_INFINITY, c, _, V = m, P = M; m.length > 0 && h.length > 0; ) {
      ...
      var b = V.pop();
      if (b.closed = true, !(b.distanceToSource > O) && (e.forEachLinkedNode(b.node.id, E), c && _))
        return C(c, _);
    }
    return fe;
    function f(w, N) {
...
z.l1 = q;
function se(e) {
  this.node = e, this.p1 = null, this.p2 = null, this.closed = false, this.g1 = Number.POSITIVE_INFINITY, this.g2 = Number.POSITIVE_INFINITY, this.f1 = Number.POSITIVE_INFINITY, this.f2 = Number.POSITIVE_INFINITY, this.h1 = -1, this.h2 = -1;
}
function ue() {
  var e = 0, t = [];
  return {
  ...
  function d(o) {
    var r = t[e];
    return r ? (r.node = o, r.p1 = null, r.p2 = null, r.closed = false, r.g1 = Number.POSITIVE_INFINITY, r.g2 = Number.POSITIVE_INFINITY, r.f1 = Number.POSITIVE_INFINITY, r.f2 = Number.POSITIVE_INFINITY, r.h1 = -1, r.h2 = -1) : (r = new se(o), t[e] = r), e++, r;
  }
}
var he = u.NO_PATH;
function G(e, t) {
  ...
  function p(x, g) {
    ...
    return B;
    function D() {
      f = S.pop(), !f.closed && (f.closed = true, f.f1 < c && f.g1 + b - r(l, f.node) < c && e.forEachLinkedNode(f.node.id, H), S.length > 0 && (V = S.peek().f1));
    }
    function C() {
      f = v.pop(), !f.closed && (f.closed = true, f.f2 < c && f.g2 + V - r(f.node, E) < c && e.forEachLinkedNode(f.node.id, m), v.length > 0 && (b = v.peek().f2));
    }
    function A(a, I) {
      var i = h.get(a.id);
...
//# sourceMappingURL=ngraph__path.js.map
